...
namespace HealthClinic.Forms__Views_.Administrator
{
    ...
    public partial class ValidateAppointmentsForm : Form
    {
        ...
        Form prevForm;
        public ValidateAppointmentsForm(HealthClinicEntities ctx, Form prevForm, UserDto user)
        {
            InitializeComponent();
        ...
        private void ValidateAppointmentsForm_Load(object sender, EventArgs e)
        {
            this.Text = res.GetString("HealthClinic");

            HealthClinicLocalization.FillControlsByLanguage(res, language, panelValidate);
        }
    }
}
